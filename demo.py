...
# records = db.Graduate_Schools
# records = db.K_12
print(records)
print(records.count_documents({})) # count the number of data
...
#     try:
#         getData(url, uId_data["Institution Name"][number])
...
#     try:
#         getData(url, uId_data["Institution Name"][i])
#         scrap_data_count = scrap_data_count + 1
#     except:
...
# #     url = "http://127.0.0.1:5500/test.html" # for testing in local host
#     try:
#         getData(url, Institute_Data_404[i])
#         scrap_data_count = scrap_data_count + 1
#     except:
#         error_to_phase.append(Institute_Data_404[i])

getData("https://www.niche.com/colleges/harvard-university/", "Harvard University")
# getData("http://127.0.0.1:5500/test.html", "Aaniiih Nakoda College")



# # To export data in json file
# print("Exporting scrapped data into JSON file")
# with open("NICHE_Data.json", "w") as jsonwrite:
#     json.dump(All_Data , jsonwrite, indent=4)
# print("Completed!")